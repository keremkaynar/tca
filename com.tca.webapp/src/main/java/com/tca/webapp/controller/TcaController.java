...
public class TcaController {
	...
	public String createContactPerson(ModelMap attributes, @ModelAttribute("currentTeam") Team currentTeam,
	...
	public String deleteContactPerson(ModelMap attributes, @ModelAttribute("currentTeam") Team currentTeam,
			@ModelAttribute("contactPerson") ContactPerson contactPerson) {
		contactPerson.setTeam(currentTeam);
